        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center;">
                 ...
                 <!-- Modal -->
<div class="modal fade" id="estadoModal3" tabindex="-1" role="dialog" aria-labelledby="estadoModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="estadoModalLabel3">Actualizar Estado</h5>
