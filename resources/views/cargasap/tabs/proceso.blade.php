<div class="panel panel-default">
      ...
      <table border="0" cellspacing="5" cellpadding="5" class="date-table">
        <tbody>
          <tr>
            ...
            <td class="label-cell" style="font-size: 14px; font-weight:bold; padding-left: 20px; padding-right: 10px;">
              Fecha Final:</td>
        ...
        <tbody>
          <tr>
            ...
            <td style="text-align: center;">
              <div style="margin-bottom: 10px; text-align: center; color: #29af1f;">Aceptada por el Cliente</div>
            </td>
            </td>
            <td style="text-align: center ; color: #29af1f;">Aprobada por Gerente</td>
            <td style="text-align: center;">
              <div style="margin-bottom: 10px; text-align: center; color: #ff8e2f">Archivo SAP pendiente Generar</div>
            </td>
            <td>
  ...
  <div class="text-center mt-4">
    <button class="btn btn-lg btn-primary" id="downloadLink">
      <i class="fa fa-file-alt" aria-hidden="true"></i> Generar Archivo Para Carga a SAP
    </button>
  </div>

  <!-- Botón de descarga oculto inicialmente -->
  <div id="downloadContainer" class="text-center mt-3" style="display: none;">
    <button id="exportTxt" class="btn btn-success btn-lg">
      <i class="fa fa-download"></i> Descargar Archivo SAP
    </button>
  </div>
