            ...
            <table border="0" cellspacing="5" cellpadding="5" class="date-table">
                <tbody>
                    <tr>
                        ...
                        <td style="padding-left: 20px;">
                            <!-- Botón Excel -->
                            <button class="btn btn-success btn-sm" id="exportButton5" onclick="exportToExcel()">
                                <i class="fa fa-file-excel"></i> Exportar Excel
                            </button>
                        </td>
                        <td class="search-controls" style="font-size: 14px; font-weight:bold;">
                            Buscar: <input type="text" id="searchInput5" placeholder="Buscar...">
                        </td>

                    </tr>
                </tbody>
            </table>
            <table id="documentTable5" class="table table-striped table-bordered display" style="width: 100%">
                <thead>
                    <h3 style="background-color: #323F52; color: #ffffff; padding: 10px; width: fit-content; border-radius: 5px;">
