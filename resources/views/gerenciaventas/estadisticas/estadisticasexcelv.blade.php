        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <label for="monthSelect" class="d-block mb-2" style="font-size: 1.2rem; font-weight: bold;">
                    <i class="fas fa-calendar-alt" style="color: #007bff; margin-right: 8px;"></i>Selecciona el año gerente:
                </label>
...
<script>
  ...
  <script>
   $(document).ready(function() {
      ...
      var table4 = $('#documentTable4').DataTable();
      var table5 = $('#documentTable5').DataTable();
      var table6 = $('#documentTable6').DataTable();
      ...
      setupGlobalSearch('#searchInput4', table4);
      setupGlobalSearch('#searchInput5', table5);
      setupGlobalSearch('#searchInput6', table6);
      ...
      setupColumnSearch(table4, '#documentTable4');
      setupColumnSearch(table5, '#documentTable5');
      setupColumnSearch(table6, '#documentTable6');
      ...
      $('#exportButton').on('click', function() {
          exportTableToExcel(table1, '#documentTable', 'Documentos 1', '   Vendedor: Pablo Ramirez Lopez.xlsx');
      });
  
      $('#exportButton2').on('click', function() {
          exportTableToExcel(table2, '#documentTable2', 'Documentos 2', 'Vendedor: Pablo Ramirez Lopez.xlsx');
      });
  
      $('#exportButton3').on('click', function() {
          exportTableToExcel(table3, '#documentTable3', 'Documentos 3', ' Vendedor: Pablo Ramirez Lopez .xlsx');
      });
      
      $('#exportButton4').on('click', function() {
          exportTableToExcel(table4, '#documentTable4', 'Documentos 4', 'Vendedor: Carlos Lopez Lara .xlsx');
      });
      $('#exportButton5').on('click', function() {
          exportTableToExcel(table5, '#documentTable5', 'Documentos 5', 'Vendedor: Carlos Lopez Lara .xlsx');
      });
      $('#exportButton6').on('click', function() {
          exportTableToExcel(table6, '#documentTable6', 'Documentos 6', 'Vendedor: Carlos Lopez Lara .xlsx');
      });
      ...
      $('#exportAllButton').on('click', function() {
          ...
          var sheet4 = exportTableToExcel(table4, '#documentTable4', 'Documentos 4');
          var sheet5 = exportTableToExcel(table5, '#documentTable4', 'Documentos 4');
          var sheet6 = exportTableToExcel(table6, '#documentTable4', 'Documentos 4');
