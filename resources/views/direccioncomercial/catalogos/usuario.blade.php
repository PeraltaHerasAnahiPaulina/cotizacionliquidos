...
<div class="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary">
    <div class="container-fluid">
        <div class="page-header-content">
            ...
            <div class="page-header-subtitle">ALTA GERENTES</div>
        </div>
    </div>
</div>
                ...
                <div class="tab-content mt-4" id="formTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="informacion" role="tabpanel" aria-labelledby="informacion-tab">
                        <form class="needs-validation" novalidate>
                            ...
                            <h4 class="mb-3">Sucursal y Tipo de gerente de ventas</h4>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="sucursal" class="form-label">* Sucursal:</label>
                                    <select class="form-select" id="sucursal" required>
                                        <option value="">AME 1</option>
                                        <option value="AME2">AME 2</option>
                                        <option value="AME3">AME 3</option>
                                        <option value="AME4">AME 4</option>
                                        <option value="AME5">AME 5</option>
                                    </select>
