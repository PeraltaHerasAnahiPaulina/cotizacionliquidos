                    ...
                    <ul class="nav nav-tabs" id="formTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="p-proceso" data-bs-toggle="tab" href="#pedidos-proceso"
                                role="tab" aria-controls="pedidos-proceso" aria-selected="true">En Proceso</a>
                        </li>
                        <li class="nav-item">
