                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <div style="margin-bottom: 10px; text-align: center; color: #ff0000;">Cancelado por Cliente
                            </div>
                        ...
                        <td>
                            ...
                            <button class="btn btn-info btn-sm" onclick="showDetails(3)">
                                <i class="fa fa-eye"></i>
                            </button>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>$9,874.50</td>
                        <td style="text-align: center;">
                            <div style="margin-bottom: 10px; text-align: center; color: #e61e1e;">Cancelado por Cliente
                            </div>
                    ...
                    <tr>
                        ...
                        <td>$15,600.90</td>
                        <td style="text-align: center;">
                            <div style="margin-bottom: 10px; text-align: center; color: #ec1515">Cancelado por Cliente
                            </div>
